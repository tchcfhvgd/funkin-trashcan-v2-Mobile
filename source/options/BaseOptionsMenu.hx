...
class BaseOptionsMenu extends MusicBeatSubstate
{
	...
	public function new()
	{
		...
		var titleText = new FlxText(50, 25, 1180, title, 32);
		titleText.setFormat(Paths.font("vcr.ttf"), 54, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		titleText.scrollFactor.set();
		titleText.borderSize = 2.4;
		add(titleText);

		descText = new FlxText(50, 800, 1180, "", 32);
