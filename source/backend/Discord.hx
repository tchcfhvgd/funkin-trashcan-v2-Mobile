...
class DiscordClient
{
	...
	private inline static final _defaultID:String = "1137637213648199760";
	...
	public static function changePresence(details:String = 'In the Menus', ?state:String, ?smallImageKey:String, ?hasStartTimestamp:Bool, ?endTimestamp:Float, largeImageKey:String = 'logo')
	{
		...
		presence.largeImageText = "Funkin' Trashcan";
